<?php
    ...
    echo '
        ...
        <head>
            ...
            <title>Atma Jogja Rental | CS</title>
                       ...
                       <div class="side-bar">
                            ...
                            <div class="menu">
                                ...
                                <div class="content-menu " >
                                    ...
                                    <a href="./verifikasiTransaksiPage.php" style="font-weight:600">Verifikasi Transaksi</a>
                                </div>
                                <div class="content-menu " >
                                    <i class="fa fa-money"></i>
                                    <a href="./verifikasiPembayaranPage.php" style="font-weight:600">Verifikasi Pembayaran</a>
                                </div>
                                <div class="content-menu " >
                                    <i class="fa fa-history"></i>
                                    <a href="./notaCSPage.php" style="font-weight:600">Nota Pembayaran</a>
                                </div>
                                <div class="content-menu " >
                                    <i class="fa fa-history"></i>
                                    <a href="./listTransaksiPage.php" style="font-weight:600">Tampil Transaksi</a>
                                </div>
                                <div class="content-menu " >
