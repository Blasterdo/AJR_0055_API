<?php
    if(isset($_GET['id_driver']) || isset($_GET['id_mobil']) || isset($_GET['id_promo'])){
        ...
        if($dataDriver){
            echo
                '<script>
                alert("Choose Driver Success"); window.location = "../page/editTransaksiPage.php"
                </script>';
        }else if($dataMobil){
            echo
                '<script>
                alert("Choose Mobil Success"); window.location = "../page/editTransaksiPage.php";
                </script>';
        }else if($dataPromo){
            echo
                '<script>
                alert("Choose Promo Success"); window.location = "../page/editTransaksiPage.php";
                </script>';
        }else{
            echo
                '<script>
                alert("Choose Driver or Mobil Failed"); window.location = "../page/editTransaksiPage.php"
                </script>';
        }
    }else {
        echo
