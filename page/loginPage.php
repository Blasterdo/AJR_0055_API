                    ...
                    <div class="card-body">
                        <form action="../process/loginProcess.php" method="post">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" placeholder="Masukkan Email.." id="email" name="email" aria-describedby="emailHelp" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Password</label>
                                <input type="password" class="form-control" placeholder="Masukkan Password..(default:yyyy-mm-dd)" id="password" name="password" required>
                                <small>Format:yyyy-mm-dd untuk pertama kali register</small>
                            </div>
